...
proxy_server_list = eval(config_parser.get("proxylistsection", "proxy_server_list"), {}, {})
...
proxy = urllib2.ProxyHandler({'http':proxy_server_list[0]})
auth = urllib2.HTTPBasicAuthHandler()
